...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks <Cursor> {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        suppPhnBtn.setOnClickListener ( new View.OnClickListener () {
            ...
            public void onClick(View v) {
                ...
                intent.setData ( Uri.parse ( "tel:789-456-8975 " ) );
    ...
    private boolean saveGrocery() {
        ...
        if (TextUtils.isEmpty ( nameString ) || TextUtils.isEmpty ( priceString ) || TextUtils.isEmpty ( qtyString ) || TextUtils.isEmpty ( supplierNameString ) || TextUtils.isEmpty ( supplierPhnString )) {
